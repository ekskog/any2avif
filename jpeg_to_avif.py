#!/usr/bin/env python3
"""
Simple JPEG to AVIF converter
Uses Pillow with pillow-avif-plugin
"""
...
def convert_jpeg_to_avif(input_path, output_path=None, quality=80):
    """
...
def main():
    print("🔄 JPEG to AVIF Converter")
    print("=" * 40)
    
    # Get input file path
    while True:
        input_path = input("\nEnter path to JPEG file (or 'quit' to exit): ").strip()
    ...
    # Perform conversion
    print("\n🚀 Starting conversion...")
    success = convert_jpeg_to_avif(input_path, output_path, quality)
